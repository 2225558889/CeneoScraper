...
if response.status_code == requests.codes.ok:
    ...
    for opinion in opinions:
        single_opinion = {
            ...
            "recommendation":opinion.select_one("span.user-post_author-recomendation > em").get_text().strip(),
            ...
            "opinion date":opinion.select_one("span.user-post__published > time:nth-child(1)")["datetime"].strip(),
            "purchase date":opinion.select_one("span.user-post__published > time:nth-child(2)")["datetime"].strip(),
            "up votes":opinion.select_one("span[id^='votes-yes']").get_text().strip(),
            "down votes":opinion.select_one("span[id^='votes-no']").get_text().strip(),
